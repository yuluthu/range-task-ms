...
1. run composer update & npm i in `range-laravel-backend` (laravel, shockingly) and `the-range-task` (react) directories respectively
2. in `range-laravel-backend`, configure db/use default sqlite
